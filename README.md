...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/EverseenMovies1/slam-mirrorbot/tree/master)
...
- **NOTE**: If you didn't upload **token.pickle**, uploading will not work. How to generate **token.pickle**? [Read here](https://github.com/EverseenMovies1/slam-mirrorbot#getting-google-oauth-api-credential-file)
